...
KeyBlade3::KeyBlade3(VECTOR startPos, VECTOR endPos, float radius, const Transform& ownerTransform)
	: SwordBase(SWORD_TYPE::KEY_BLADE_3, startPos, endPos, radius, ownerTransform)
{
	scl = 1.5f;
}
